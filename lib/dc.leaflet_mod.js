...
(function() { function _dc_leaflet(dc) {
    ...
    dc_leaflet.leafletBase = function(_chart) {
        ...
        var _mapOptions=globals.config.map.mapOptions;
    ...
    dc_leaflet.markerChart = function(parent, chartGroup) {
        ...
        var _cluster = globals.config.map.doMarkerClustering; // requires leaflet.markerCluster
        var _clusterOptions={
          showCoverageOnHover: globals.config.map.showCoverageOnHover,
          zoomToBoundsOnClick: globals.config.map.zoomToBoundsOnClick
        };
